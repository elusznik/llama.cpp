...
void quantize_row_tbq34_0(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
...
void quantize_row_tbqp34_0(const float * GGML_RESTRICT x, void * GGML_RESTRICT y, int64_t k);
...
void ggml_vec_dot_tbq34_0_q8_K(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
...
void ggml_vec_dot_tbqp34_0_q8_K(int n, float * GGML_RESTRICT s, size_t bs, const void * GGML_RESTRICT vx, size_t bx, const void * GGML_RESTRICT vy, size_t by, int nrc);
