        ...
        case GGML_OP_SET_ROWS:
            {
                return (op->type == GGML_TYPE_F32 || op->type == GGML_TYPE_F16 || op->type == GGML_TYPE_BF16 ||
                       ...
                       op->type == GGML_TYPE_TBQ34_0 || op->type == GGML_TYPE_TBQP3_0 ||
                       op->type == GGML_TYPE_TBQP4_0 || op->type == GGML_TYPE_TBQP34_0) &&
        ...
        case GGML_OP_CPY:
            {
                ...
                if ((src0_type == GGML_TYPE_TBQ3_0 || src0_type == GGML_TYPE_TBQ4_0 ||
                     src0_type == GGML_TYPE_TBQP3_0 || src0_type == GGML_TYPE_TBQP4_0) &&
