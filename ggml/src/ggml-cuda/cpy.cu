...
void ggml_cuda_cpy(ggml_backend_cuda_context & ctx, const ggml_tensor * src0, ggml_tensor * src1) {
    ...
    if (src0->type == src1->type && contiguous_srcs) {
        ...
        ggml_cpy_q5_1_f32_cuda
                ...
                src0->type == GGML_TYPE_TBQ34_0 ||
                src0->type == GGML_TYPE_TBQP3_0 || src0->type == GGML_TYPE_TBQP4_0 ||
                src0->type == GGML_TYPE_TBQP34_0) && src1->type == GGML_TYPE_F16) {
        ...
        to_fp16(src0_ddc, (half *) src1_ddc, src0->ne[0], src0->ne[1], src0->ne[2], src0->ne[3], s01, s02, s03, main_stream);
                ...
                src0->type == GGML_TYPE_TBQ34_0 ||
                src0->type == GGML_TYPE_TBQP3_0 || src0->type == GGML_TYPE_TBQP4_0 ||
                src0->type == GGML_TYPE_TBQP34_0) && src1->type == GGML_TYPE_F32) {
        GGML_ASSERT(ggml_is_contiguous(src1));
        GGML_ASSERT(src0->nb[0] == ggml_type_size(src0->type));
