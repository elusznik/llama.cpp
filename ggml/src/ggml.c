...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TBQ34_0] = {
        .type_name                = "tbq34_0",
        .blck_size                = QK_K,
        .type_size                = sizeof(block_tbq34_0),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_tbq34_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_tbq34_0_ref,
    },
    [GGML_TYPE_TBQP3_0] = {
        .type_name                = "tbqp3_0",
        .blck_size                = QK_K,
    ...
    [GGML_TYPE_TBQP34_0] = {
        .type_name                = "tbqp34_0",
        .blck_size                = QK_K,
        .type_size                = sizeof(block_tbqp34_0),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_tbqp34_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_tbqp34_0_ref,
    },
};
...
size_t ggml_quantize_chunk(
    ...
    switch (type) {
        ...
        case GGML_TYPE_TBQ34_0: result = quantize_tbq34_0(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
        ...
        case GGML_TYPE_TBQP34_0:result = quantize_tbqp34_0(src + start, (char *) dst + start_row * row_size, nrows, n_per_row, imatrix); break;
