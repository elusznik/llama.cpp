                ...
                if (llm_arch_is_recurrent(arch)) {
                    ...
                    if (hparams.swa_type != LLAMA_SWA_TYPE_NONE) {
                        ...
                        res = new llama_memory_hybrid_iswa(
                            ...
                            /* attn_type_k_out   */ params.type_k_outlier,
                            /* attn_type_v_out   */ params.type_v_outlier,
                            /* attn_k_out_ch     */ params.n_outlier_k_ch,
                            /* attn_v_out_ch     */ params.n_outlier_v_ch,
                    ...
                    if (hparams.swa_type != LLAMA_SWA_TYPE_NONE) {
                        ...
                        res = new llama_kv_cache_iswa(
                                *this,
                                params.type_k,
                                params.type_v,
                                params.type_k_outlier,
                                params.type_v_outlier,
                                params.n_outlier_k_ch,
                                params.n_outlier_v_ch,
                                !cparams.flash_attn,
                                cparams.offload_kqv,
                                params.swa_full,
                                cparams.kv_unified,
